    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-grow container mx-auto p-4 sm:p-6 lg:p-8">
        <div className="flex items-center mb-6">
          ...
          <h2 className="text-3xl font-bold text-foreground">{category.name} Activities</h2>
        </div>
        ...
        {activities.length > 0 ? (
          ...
          <p className="text-center text-muted-foreground text-lg">No activities found for this category yet.</p>
        )}
      </main>
      <MadeWithDyad />
    </div>
